...
# ==========================================================
# Экспорт очищенного датасета — пригодится для отчёта и для
# дальнейшей разработки информационной системы прогнозирования
# ==========================================================
...
print("\nВАЖНО: если откроете .csv в Excel/LibreOffice, числа вида 16.2, 9.2")
print("и т.п. в столбцах площади МОГУТ автоматически превратиться в даты")
print("('16.фев', '09.фев') — это стандартный баг автораспознавания формата")
print("при ОТКРЫТИИ csv в Excel, а не ошибка в самом файле или в коде.")
print("Сами данные на диске в .csv остаются корректными числами.")
print("Чтобы не столкнуться с этим повторно — используйте .xlsx-версию")
print("файла для просмотра/редактирования вручную, а .csv не открывайте")
print("напрямую двойным кликом (или при открытии в Excel используйте")
print("мастер импорта текста и явно указывайте тип столбца 'Текст').")
print("\nГотово.")